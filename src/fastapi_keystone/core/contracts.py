...
class AppManagerProtocol(Protocol):
    ...
    def register_provider(self, cls: Type[T], provider: Any, scope: ScopeDecorator = ...) -> None: ...

class ServerProtocol(Protocol):
    """
    Protocol for Server contract.
    """
    def on_startup(self, func: Optional[Callable[[FastAPI, Any], Awaitable[None]]] = None) -> "ServerProtocol": ...
    def on_shutdown(self, func: Optional[Callable[[FastAPI, Any], Awaitable[None]]] = None) -> "ServerProtocol": ...
    def enable_tenant_middleware(self) -> "ServerProtocol": ...
    def add_middleware(self, middleware_class: Any, **kwargs: Any) -> "ServerProtocol": ...
