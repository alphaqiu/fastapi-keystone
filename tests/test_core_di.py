...
class TestAppInjector:
    ...
    def test_complex_dependency_chain(self):
        ...
        class ComplexModule(Module):
            ...
            @provider
            @injector_singleton
            def provide_service_c(self, service_a: ServiceA, service_b: ServiceB) -> ServiceC:
        ...
        assert service_c.service_b.service_a is service_c.service_a  # 共享同一个 ServiceA 实例
